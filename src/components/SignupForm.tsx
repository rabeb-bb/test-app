    ...
    <Card style={{ width: "35%", margin: "auto", marginTop: "100px" }}>
      ...
      <CardContent>
        ...
        {/* <div>
          ...
          >
            <p>Sign in using your social media:</p>
            <Button
              onClick={async () => await signIn({ provider: "google" })}
              variant={"outlined"}
              //style={styleSetting}
            ...
            <Button
              onClick={async () => await signIn({ provider: "facebook" })}
              variant={"outlined"}
              style={{ margin: "1%", width: "50%" }}
            >
              <img
                src="data:image/png;base64,"
                width="20"
              />
              Facebook
            </Button>
